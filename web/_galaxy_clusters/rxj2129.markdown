...
- **Status**: {{ page.status }}
- **Reference to be cited**: [Keatley & Harris (2025)](https://ui.adsabs.harvard.edu/abs/2025arXiv250803626K/abstract)
...
<ul>
<li><a href="{{ site.baseurl }}/data/rxj2129/jwst_miri_observations.fits" target="_blank">Photometric GC catalogue - v1</a></li>
</ul>
