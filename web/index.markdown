...
| {{ galaxy_cluster.name }} | {% if galaxy_cluster.redshift and galaxy_cluster.redshift != "" and galaxy_cluster.redshift != "---" %}{{ galaxy_cluster.redshift }}{% else %}N/A{% endif %} | {{ galaxy_cluster.status }}|[Zenodo]({% if galaxy_cluster.url_zenodo and galaxy_cluster.url_zenodo != "" and galaxy_cluster.url_zenodo != "---" %}{{ galaxy_cluster.url_zenodo }}{% else %}N/A{% endif %}) | 
{% endfor %}